...
int main(){
    ...
    printf(ANSI_COLOR_WHITE ">= 38 ");
    printf(ANSI_COLOR_RED ">= 37 " ANSI_COLOR_RESET);
    printf(ANSI_COLOR_YELLOW ">= 36 " ANSI_COLOR_RESET);
    printf(ANSI_COLOR_GREEN ">= 35 " ANSI_COLOR_RESET);
    printf(ANSI_COLOR_CYAN ">= 34 " ANSI_COLOR_RESET);
    printf(ANSI_COLOR_BLUE ">= 33 " ANSI_COLOR_RESET);
    std::cout << std::endl;
